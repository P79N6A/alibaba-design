<template>
  <div class="page-brand-principles">
    <header>
      <h1>{{ $t('设计原则') }}</h1>
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        <el-tab-pane :label="$t('总览')" name="tab1" />
        <el-tab-pane :label="$t('重要性及场景')" name="tab2" />
      </el-tabs>
    </header>
    <transition name="el-fade-in-linear">
      <div key="Overview" v-if="activeName === 'tab1'" class="content">
        <p>
          {{
            $t(
        ...
        <div class="item">
          <div>
            ...
            <div class="right">
              <div class="img-box">
                <img src="https://img.alicdn.com/tfs/TB1anFyEPTpK1RjSZKPXXa3UpXa-470-234.png" alt>
              </div>
            </div>
          </div>
        </div>
        <div class="item">
          <div>
            ...
            <div class="right">
              <div class="img-box">
                <img src="https://img.alicdn.com/tfs/TB1FT4xESzqK1RjSZFLXXcn2XXa-470-234.png" alt>
              </div>
            </div>
          </div>
        </div>
        <div class="item">
          <img src="https://img.alicdn.com/tfs/TB167FzESzqK1RjSZFHXXb3CpXa-44-44.png" alt>
          <div>
            <div class="left">
              <h1 class="h1">
                {{ $t('清晰 & 简洁') }}
            ...
            <div class="right">
              <div class="img-box">
                <img src="https://img.alicdn.com/tfs/TB1oeVJENYaK1RjSZFnXXa80pXa-470-234.png" alt>
              </div>
            </div>
          </div>
        </div>
        <div class="item">
          <img src="https://img.alicdn.com/tfs/TB10wpJENYaK1RjSZFnXXa80pXa-44-44.png" alt>
          <div>
            <div class="left">
              <h1 class="h1">
                {{ $t('⽤户成⻓') }}
            ...
            <div class="right">
              <div class="img-box">
                <img src="https://img.alicdn.com/tfs/TB1lM0uEHPpK1RjSZFFXXa5PpXa-470-234.png" alt>
              </div>
            </div>
          </div>
        </div>
        <div class="item">
          <img src="https://img.alicdn.com/tfs/TB1c58sEMTqK1RjSZPhXXXfOFXa-44-44.png" alt>
          <div>
            <div class="left">
              <h1 class="h1">
                {{ $t('无距离感') }}
              ...
              <p>
                ...
                <br>
                {{
                  $t('地理上⽆距离，在服务和产品层⾯符合⽤户的本地化⼼智。')
                }}
                <br>
                {{
                  $t('⼼理上⽆距离，在⽤户⼼理上建⽴⼀种贴⼼，可靠的感觉。')
                }}
              </p>
            </div>
            <div class="right">
              <div class="img-box">
                <img src="https://img.alicdn.com/tfs/TB1HIXvESzqK1RjSZPxXXc4tVXa-470-234.png" alt>
              </div>
            </div>
          </div>
          <p>
            {{ $t('上一篇') }}:&nbsp;&nbsp;
            <a href="../keywords/index.html">{{ $t('关键词') }}</a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            {{ $t('下一篇') }}:&nbsp;&nbsp;
            <a href="../product/index.html">{{ $t('产品') }}</a>
          </p>
        </div>
      </div>
      <div v-else-if="activeName === 'tab2'" class="content">
        <h1 class="h1">
          {{ $t('安全 & 信任') }}
        </h1>
        <p>
...
.page-brand-principles {
  header {
    position: relative;
    text-align: left;
    background: #ebebeb;
    padding: 0 120px;
    background-image: url('https://img.alicdn.com/tfs/TB1.i4GEQvoK1RjSZFwXXciCFXa-1632-240.png');
  ...
  .content .item > div .left h2 {
    margin-bottom: 0;
  }
  .content .item > div .left .subtitle {
    color: #999999;
    font-size: 14px;
    line-height: 26px;
    margin-bottom: 20px;
